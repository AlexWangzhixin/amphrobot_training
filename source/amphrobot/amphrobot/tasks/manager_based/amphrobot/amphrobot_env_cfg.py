...
from amphrobot.robots.amphrobot import AMPHROBOT_CFG as ROBOT_CFG
from amphrobot.tasks.manager_based.amphrobot import mdp
...
class RewardsCfg:
    ...
    track_lin_vel_xy = RewTerm(
        func=mdp.track_lin_vel_xy_exp, weight=3, params={"command_name": "base_velocity", "std": math.sqrt(0.25)}
    )
    ...
    undesired_contacts = RewTerm(
        ...
        params={
            "threshold": 1,
            "sensor_cfg": SceneEntityCfg("contact_forces", body_names=[".*_Side_link", ".*Thigh_link"]),
        },
    )
...
class TerminationsCfg:
    ...
    base_contact = DoneTerm(
        ...
        params={"sensor_cfg": SceneEntityCfg("contact_forces", body_names="base_link"), "threshold": 1000.0},
    )
...
@configclass
class AmphrobotEnvCfg(ManagerBasedRLEnvCfg):
...
@configclass
class AmphrobotPlayEnvCfg(AmphrobotEnvCfg):
    def __post_init__(self):
        super().__post_init__()
